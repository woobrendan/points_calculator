...
selected_style = "px-4 py-2 text-sm font-medium text-white bg-black-600 border border-red-500 rounded-lg hover:bg-black hover:text-red-400 hover:border-red-500"

import { ReqPointsArr, ManufacturerPoints } from "../models/Points/points_models";
import SeriesPoints from "../models/Points/seriesPoints_schema";

const handleManufPoints = async (manufObj: ReqPointsArr, seriesName: string, round: string) => {
  ...
  try {
    ...
    if (series) {
        ...
        // Loop through the incoming array of results, and loop through the backend manuf Obj to match classes
